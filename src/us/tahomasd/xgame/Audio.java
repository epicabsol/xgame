...
class Audio {
	public static ALDevice device = null;
	public static ALCCapabilities caps = null;
	public static ALContext context = null;
	public static long contextHandle = -1;
	...
	public static void MakeInitialized()
	{
		if (!Initialized())
		{
			...
			if (!caps.OpenALC10)
			{
				System.out.println("OpenAL 1.0 Not supported!! \nAudio things probably won't work!");
			}
			...
			contextHandle = alcCreateContext(device.getPointer(), attribs);
			if (contextHandle == 0)
			{
